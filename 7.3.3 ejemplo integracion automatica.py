...
class Polynomial(object):
    ...
    #podemos incluir otro método que se encargue de imprimir el polinomio 
    ...
    def __str__(self):
        ...
        #lo anterior tiene muchos inconvenientes en términos de notación matemática dado que 
        # van a apararecer términos inecesarios en la cadena de string que 
        # necesitamos imprimir 
        # una version más mejorada es la siguiente...
...
#para imprimir los polinomios tenemos..
pc = Polynomial([1, -1])
print(pc)
pd = Polynomial([0, 11, 2, 3, 4, -3, -2, -1])
print(pd)
...
# la función test para verificar la clase polinomio puede ir de la forma..
...
# 7.3.8. operaciones aritméticas y otros métodos especiales (IMPORTANTE  LIBRO PÁG 449)
